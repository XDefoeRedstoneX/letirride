<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
    ...
    <div class="sm:col-span-2">
        ...
        <input type="text" name="description" class="w-full px-4 py-3 bg-foreground/5 border-2 border-border/50 rounded-xl text-xs font-bold text-foreground outline-none focus:border-primary focus:ring-4 focus:ring-primary/20 transition-all" placeholder="+5% Rare+ chance for 30 minutes.">
    </div>
    <div>
    ...
    <div>
        ...
        <input type="number" name="duration_minutes" required min="1" max="1440" class="w-full px-4 py-3 bg-foreground/5 border-2 border-border/50 rounded-xl text-xs font-bold text-foreground outline-none focus:border-primary focus:ring-4 focus:ring-primary/20 transition-all" placeholder="30">
    </div>
