        ...
        <div class="px-frame-content">
            ...
            <div class="p-6">
                ...
                <a href="{{ route('auth.google') }}"
                   class="flex items-center justify-center gap-3 w-full px-4 py-3 bg-background border-2 border-input rounded-xl font-bold text-sm hover:border-primary/50 hover:bg-primary/5 transition-all">
