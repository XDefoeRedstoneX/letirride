<x-app-layout>
    @auth
        <div class="space-y-10" x-data="{ 
            ...
            animationClass: '',
            dragOffset: 0,
            items: @json($prizes, JSON_HEX_QUOT),
            cost: { points: {{ $spinCost }}, balance: 15000 },
            ...
            <div class="text-center space-y-2">
                <div class="flex items-center justify-center gap-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="text-primary"><path d="M7 11V7a5 5 0 0 1 10 0v4"/><rect width="18" height="12" x="3" y="11" rx="2"/><circle cx="12" cy="17" r="1"/></svg>
                            ...
                            <template x-for="item in items" :key="i + '-' + item.id">
                                    <div class="w-40 flex-shrink-0 glass-card border-2 rounded-2xl p-4 flex flex-col items-center justify-center gap-3"
                                         :class="{
                                            ...
                                            'border-purple-500/50': item.rarity === 'epic',
                                            'border-amber-500/50': item.rarity === 'legendary',
                                            'border-rose-500/50': item.rarity === 'grand_prize',
                                         }">
                                    ...
                                    <span class="text-[8px] font-black uppercase px-2 py-0.5 rounded-full border"
                                          :class="{
                                            ...
                                            'text-purple-400 border-purple-500/30 bg-purple-500/10': item.rarity === 'epic',
                                            'text-amber-400 border-amber-500/30 bg-amber-500/10': item.rarity === 'legendary',
                                            'text-rose-400 border-rose-500/30 bg-rose-500/10': item.rarity === 'grand_prize',
                            ...
                            <div class="flex items-center justify-between text-[10px] font-black uppercase tracking-tighter">
                                <div class="flex items-center gap-2">
                                    <div class="w-1.5 h-1.5 rounded-full" :class="{
                                        ...
                                        'bg-amber-500': item.rarity === 'legendary',
                                        'bg-rose-500': item.rarity === 'grand_prize',
                                    }"></div>
            ...
            <div x-show="showResult" class="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md" x-transition>
                <div class="bg-card border-2 border-primary/50 rounded-[2rem] p-8 max-w-sm w-full text-center space-y-6 shadow-2xl shadow-primary/30">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-xs text-muted-foreground" x-text="winner && winner.discount_name ? winner.discount_name : 'Congratulations on your prize!'"></p>
                    </div>
    ...
    @else
        <div class="min-h-[70vh] flex flex-col items-center justify-center text-center space-y-12 p-6">
            <div class="space-y-6 max-w-xl">
                ...
                <h1 class="text-5xl font-black tracking-tighter leading-tight ">Spin Your Luck in The <span class="text-primary">Carousel</span></h1>
