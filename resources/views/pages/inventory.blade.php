                ...
                <div class="glass-card rounded-[2.5rem] p-6 flex gap-6 items-center group hover:shadow-2xl hover:shadow-primary/5 transition-all duration-500 border-border/50"
                    ...
                    <div class="flex-1 min-w-0 space-y-3">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button @click="copyCode(item.code, index)"
                                    class="w-10 h-10 flex items-center justify-center rounded-xl bg-foreground/5 hover:bg-primary/10 hover:text-primary transition-all text-muted-foreground group/btn">
                                <template x-if="copiedIndex === index">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="pixel-render text-green-500"><polyline points="20 6 9 17 4 12"/></svg>
                                </template>
                                <template x-if="copiedIndex !== index">
