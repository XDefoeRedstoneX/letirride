<x-app-layout>
    <div class="max-w-5xl mx-auto space-y-8" x-data="{ 
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <!-- Items List -->
            <div class="lg:col-span-2 space-y-4" x-show="!paid">
            ...
            <!-- Order Summary -->
            <div class="space-y-6" x-show="!paid">
            ...
            <!-- Success State -->
            <div x-show="paid" class="col-span-3 py-20 text-center space-y-8 max-w-lg mx-auto">
